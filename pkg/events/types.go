...
const (
	...
	EventPromptValidationWarning EventType = "prompt_validation_warning"
...
// PromptValidationWarningData contains data for EventPromptValidationWarning
type PromptValidationWarningData struct {
	Message string
}
